...
export default function CustomerCarousel() {
  return (
    <main className="max-w-screen-2xl mx-auto mt-14">
        ...
        <div className="w-[95%] md:w-[80%] p-3 md:p-0">
          ...
          <div className="relative mt-10 bg-red-">
            ...
            <Carousel className="w-full md:max-w-[100%] mx-auto relative">
              {/* Buttons */}
              <CarouselPrevious className="absolute top-[-1rem] md:top-[-3rem]  left-[230px] md:left-[500px] lg:left-[700px] xl:left-[920px] text-gray-700 hover:text-black" />
              <CarouselNext className="absolute top-[-1rem] md:top-[-3rem]   right-0 md:right-2 text-gray-700 hover:text-black" />
