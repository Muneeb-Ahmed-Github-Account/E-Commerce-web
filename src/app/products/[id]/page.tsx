...
export default function Pro_Details(){
    ...
    const id = params.id
    const items = Top_products.find((item)=>item.id === Number(id))
    if(!items){
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row justify-evenly sm:mt-10 p-5 sm:m-0">
            ...
            <div className="flex sm:flex-col justify-between items-center w-full md:w-[142px] mt-3 sm:mt-0 order-2 sm:order-1">
                <Image src={items.img1} className="w-[100px] sm:w-full h-[100px] sm:h-[150px]" alt="product_Image" width={100} height={100}></Image>
                <Image src={items.img2} className="w-[100px] sm:w-full h-[100px] sm:h-[150px] sm:mt-3 " alt="product_Image" width={100} height={100}></Image>
                <Image src={items.img3} className="w-[100px] sm:w-full h-[100px] sm:h-[150px] sm:mt-3 " alt="product_Image" width={100} height={100}></Image>
            </div>
            {/*MEDIUM DIV*/}
            <div className="w-[100%] sm:w-[444px] h-[350px] sm:h-[500px] px-4 mt-5 sm:mt-0 order-1 sm:order-2">
            <Image src={items.img4} className="w-full h-[100%]" alt="product_Image" width={100} height={100}></Image>
            </div>
            {/*RIGHT DIV*/}
             <div className="w-full sm:w-[600px] h-[500px] order-3">
            <div>
                <h1 className="text-2xl md:text-3xl font-extrabold mt-4">{items.title}</h1>
            </div>
            ...
            <div>
                <p className="font-bold text-xl mt-3">{items.price} <span className="line-through text-gray-400">{items.old_price}</span></p>
                <p className="text-gray-600 mt-4">This graphic t-shirt which is perfect for any occasion. Crafted from a soft and breathable fabric, it offers superior comfort and style.</p>
            </div>
            <hr className="mt-5"/>
            {/*SELECT COLOR*/}
            <div className="mt-5">
